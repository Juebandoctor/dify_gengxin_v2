...
# MinerU OCR 配置
MINERU_API_KEY = "eyJ0eXBlIjoiSldUIiwiYWxnIjoiSFM1MTIifQ..e9QP0soJ-H3lOXQKtzG8Lja5HUV9cjLhfQIlezDnCAbHVpXg-rBXJ3LZpHlofhemX-fNM_PT9LUn_Um3Flwclg"
...
MAX_OCR_FILE_SIZE = 200 * 1024 * 1024  # 200MB
        ...
        for attempt in range(1, 4):
            try:
                ...
                payload = {
                    ...
                    "enable_table": MINERU_ENABLE_TABLE,
                    "files": [
                        {"name": basename, "is_ocr": True, "data_id": basename}
                    ]
                }
                                ...
                                try:
                                    ...
                                    if rzip.status_code == 200:
                                        ...
                                        if extracted_text:
                                            ...
                                            txt_path = os.path.join(OCR_OUTPUT_DIR, f"{base_name}_ocr.md")
